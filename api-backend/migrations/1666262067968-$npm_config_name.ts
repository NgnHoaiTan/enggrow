...
export class $npmConfigName1666262067968 implements MigrationInterface {
    name = '$npmConfigName1666262067968'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`status\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`type\` int NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`interval\` int NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`repetition\` int NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`efactor\` decimal NOT NULL DEFAULT '3'`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`dueDate\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`dueDate\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`efactor\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`repetition\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`interval\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`type\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`status\` varchar(20) NOT NULL DEFAULT ''new-word''`);
    }
