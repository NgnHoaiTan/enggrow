...
export class $npmConfigName1669028122172 implements MigrationInterface {
    name = '$npmConfigName1669028122172'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`example\` varchar(100) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`dueDate\` \`dueDate\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`example\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`example\` varchar(30) NULL DEFAULT 'NULL'`);
