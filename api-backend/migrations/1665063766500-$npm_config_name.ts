...
export class $npmConfigName1665063766500 implements MigrationInterface {
    name = '$npmConfigName1665063766500'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`pronunciation_practice_tags\` (\`pronunciationPracticeId\` int NOT NULL, \`tagId\` int NOT NULL, INDEX \`IDX_835fb6f86da2796e9a85878ef4\` (\`pronunciationPracticeId\`), INDEX \`IDX_556424142f3cfa7cc8174ffa43\` (\`tagId\`), PRIMARY KEY (\`pronunciationPracticeId\`, \`tagId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`pronunciation_practice_tags\` ADD CONSTRAINT \`FK_835fb6f86da2796e9a85878ef42\` FOREIGN KEY (\`pronunciationPracticeId\`) REFERENCES \`pronunciation_practice\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`pronunciation_practice_tags\` ADD CONSTRAINT \`FK_556424142f3cfa7cc8174ffa43b\` FOREIGN KEY (\`tagId\`) REFERENCES \`tag\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`pronunciation_practice_tags\` DROP FOREIGN KEY \`FK_556424142f3cfa7cc8174ffa43b\``);
        await queryRunner.query(`ALTER TABLE \`pronunciation_practice_tags\` DROP FOREIGN KEY \`FK_835fb6f86da2796e9a85878ef42\``);
        await queryRunner.query(`ALTER TABLE \`user\` DROP FOREIGN KEY \`FK_c28e52f758e7bbc53828db92194\``);
        await queryRunner.query(`ALTER TABLE \`notification\` DROP FOREIGN KEY \`FK_1ced25315eb974b73391fb1c81b\``);
        await queryRunner.query(`ALTER TABLE \`reels\` DROP FOREIGN KEY \`FK_820c8217367f2a5e30d2578741a\``);
        await queryRunner.query(`ALTER TABLE \`live_course\` DROP FOREIGN KEY \`FK_daa784d4534061040a307eacc9d\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_556424142f3cfa7cc8174ffa43\` ON \`pronunciation_practice_tags\``);
        await queryRunner.query(`DROP INDEX \`IDX_835fb6f86da2796e9a85878ef4\` ON \`pronunciation_practice_tags\``);
        await queryRunner.query(`DROP TABLE \`pronunciation_practice_tags\``);
    }
