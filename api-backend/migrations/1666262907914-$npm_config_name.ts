...
export class $npmConfigName1666262907914 implements MigrationInterface {
    name = '$npmConfigName1666262907914'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`efactor\` float NOT NULL DEFAULT '3'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`dueDate\` \`dueDate\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`efactor\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`efactor\` decimal(10,0) NOT NULL DEFAULT '3'`);
