...
export class $npmConfigName1669276105068 implements MigrationInterface {
    name = '$npmConfigName1669276105068'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`staff_experience\` ADD \`from_time\` date NULL`);
