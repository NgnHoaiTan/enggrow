...
export class $npmConfigName1669052601689 implements MigrationInterface {
    name = '$npmConfigName1669052601689'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`card_pronunciation_result\` ADD \`pronounce_url\` varchar(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`card_pronunciation_result\` ADD \`pronounce_id\` varchar(30) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`card_learned\` CHANGE \`learned_at\` \`learned_at\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`card_pronunciation_result\` DROP COLUMN \`pronounce_id\``);
        await queryRunner.query(`ALTER TABLE \`card_pronunciation_result\` DROP COLUMN \`pronounce_url\``);
    }
