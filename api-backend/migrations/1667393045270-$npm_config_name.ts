...
export class $npmConfigName1667393045270 implements MigrationInterface {
    name = '$npmConfigName1667393045270'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`pronunciation_course\` ADD \`poster\` varchar(255) NOT NULL`);
