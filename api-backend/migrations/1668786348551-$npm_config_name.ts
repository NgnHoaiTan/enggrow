...
export class $npmConfigName1668786348551 implements MigrationInterface {
    name = '$npmConfigName1668786348551'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`staff_profileId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`staff_profileId\``);
    }
