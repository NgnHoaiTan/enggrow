...
export class $npmConfigName1668854079377 implements MigrationInterface {
    name = '$npmConfigName1668854079377'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`avatar\` DROP COLUMN \`link_image\``);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`current_avatar\` \`current_avatar\` varchar(100) NOT NULL DEFAULT 'https://res.cloudinary.com/hoaitan/image/upload/v1668854027/engrow/no_avatar_gd2rni.jpg'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`current_avatar\` \`current_avatar\` varchar(100) NOT NULL DEFAULT ''https://deejayfarm.com/wp-content/uploads/2019/10/Profile-pic.jpg''`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`bio\` varchar(100) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`staff_profile\` ADD \`link_certification\` varchar(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`avatar\` ADD \`link_image\` varchar(255) NOT NULL`);
    }
