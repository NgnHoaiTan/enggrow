...
export class $npmConfigName1668786254599 implements MigrationInterface {
    name = '$npmConfigName1668786254599'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`card_learned\` CHANGE \`learned_at\` \`learned_at\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`staffProfileId\` int NULL DEFAULT 'NULL'`);
    }
