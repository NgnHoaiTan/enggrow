...
export class $npmConfigName1665847852870 implements MigrationInterface {
    name = '$npmConfigName1665847852870'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`status\` \`status\` varchar(20) NOT NULL DEFAULT 'new-word'`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`current_avatar\` \`current_avatar\` varchar(255) NOT NULL DEFAULT 'https://deejayfarm.com/wp-content/uploads/2019/10/Profile-pic.jpg'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`current_avatar\` \`current_avatar\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`status\` \`status\` varchar(20) NOT NULL`);
