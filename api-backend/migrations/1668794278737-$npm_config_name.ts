...
export class $npmConfigName1668794278737 implements MigrationInterface {
    name = '$npmConfigName1668794278737'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_801282d422e1568ed4e512a687\` ON \`user\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`last_online\` datetime NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`is_online\` tinyint NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`last_online\``);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_801282d422e1568ed4e512a687\` ON \`user\` (\`staff_profileId\`)`);
    }
