...
export class $npmConfigName1669350249666 implements MigrationInterface {
    name = '$npmConfigName1669350249666'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`folder_flashcard\` DROP COLUMN \`progress\``);
        await queryRunner.query(`ALTER TABLE \`pronunciation_exercise\` DROP COLUMN \`meaning\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`meaning\` \`meaning\` tinytext NULL`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`example\` \`example\` varchar(100) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`staff_experience\` CHANGE \`from_time\` \`from_time\` date NULL`);
        await queryRunner.query(`ALTER TABLE \`staff_experience\` CHANGE \`to_time\` \`to_time\` date NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`pronunciation_course\` ADD \`poster_id\` varchar(50) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`pronunciation_course\` DROP COLUMN \`poster_id\``);
        await queryRunner.query(`ALTER TABLE \`pronunciation_course\` ADD \`poster_id\` varchar(30) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`staff_experience\` CHANGE \`to_time\` \`to_time\` date NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`staff_experience\` CHANGE \`from_time\` \`from_time\` date NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`staff_experience\` ADD CONSTRAINT \`FK_0b7d1ebb48f77c3dccdaacd69f4\` FOREIGN KEY (\`staffProfileId\`) REFERENCES \`staff_profile\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`dueDate\` \`dueDate\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`example\` \`example\` varchar(100) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`meaning\` \`meaning\` tinytext NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`pronunciation_exercise\` ADD \`meaning\` tinytext NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`folder_flashcard\` ADD \`progress\` int NOT NULL DEFAULT '0'`);
    }
