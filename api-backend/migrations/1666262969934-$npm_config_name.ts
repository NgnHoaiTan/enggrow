...
export class $npmConfigName1666262969934 implements MigrationInterface {
    name = '$npmConfigName1666262969934'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`efactor\` decimal(2,2) NOT NULL DEFAULT '2.50'`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`dueDate\` \`dueDate\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`dueDate\` \`dueDate\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`efactor\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`efactor\` float(12) NOT NULL DEFAULT '3'`);
