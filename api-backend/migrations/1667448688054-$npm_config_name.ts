...
export class $npmConfigName1667448688054 implements MigrationInterface {
    name = '$npmConfigName1667448688054'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`pronunciation_course\` ADD \`poster_id\` varchar(255) NOT NULL`);
