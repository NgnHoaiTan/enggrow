...
export class $npmConfigName1669275977864 implements MigrationInterface {
    name = '$npmConfigName1669275977864'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_0b7d1ebb48f77c3dccdaacd69f4\` ON \`staff_experience\``);
        await queryRunner.query(`ALTER TABLE \`staff_experience\` ADD \`from_time\` datetime NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`staff_experience\` CHANGE \`to_time\` \`to_time\` datetime NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`staff_experience\` CHANGE \`to_time\` \`to_time\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`dueDate\` \`dueDate\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        ...
        await queryRunner.query(`ALTER TABLE \`staff_experience\` DROP COLUMN \`from_time\``);
        await queryRunner.query(`CREATE INDEX \`FK_0b7d1ebb48f77c3dccdaacd69f4\` ON \`staff_experience\` (\`staffProfileId\`)`);
    }
