...
export class $npmConfigName1669275737590 implements MigrationInterface {
    name = '$npmConfigName1669275737590'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`staff_experience\` ADD \`from_time\` date NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`staff_experience\` DROP COLUMN \`to_time\``);
        await queryRunner.query(`ALTER TABLE \`staff_experience\` ADD \`to_time\` date NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`staff_experience\` DROP COLUMN \`to_time\``);
        await queryRunner.query(`ALTER TABLE \`staff_experience\` ADD \`to_time\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`staff_experience\` DROP COLUMN \`from_time\``);
