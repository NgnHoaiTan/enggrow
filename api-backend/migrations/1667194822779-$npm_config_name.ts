...
export class $npmConfigName1667194822779 implements MigrationInterface {
    name = '$npmConfigName1667194822779'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`episode\` DROP COLUMN \`video\``);
        await queryRunner.query(`ALTER TABLE \`episode\` ADD \`video_url\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`episode\` ADD \`video_file_name\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`episode\` DROP COLUMN \`video_file_name\``);
        await queryRunner.query(`ALTER TABLE \`episode\` DROP COLUMN \`video_url\``);
        await queryRunner.query(`ALTER TABLE \`episode\` ADD \`video\` varchar(255) NULL DEFAULT 'NULL'`);
    }
