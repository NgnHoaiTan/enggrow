...
export class $npmConfigName1669276231779 implements MigrationInterface {
    name = '$npmConfigName1669276231779'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`staff_experience\` ADD \`from_time\` date NULL DEFAULT 'NULL'`);
    }
