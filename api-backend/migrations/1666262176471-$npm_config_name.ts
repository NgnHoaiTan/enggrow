...
export class $npmConfigName1666262176471 implements MigrationInterface {
    name = '$npmConfigName1666262176471'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`efactor\` \`efactor\` decimal(1,2) NOT NULL DEFAULT '2.50'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`dueDate\` \`dueDate\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` CHANGE \`efactor\` \`efactor\` decimal(10,0) NOT NULL DEFAULT '3'`);
