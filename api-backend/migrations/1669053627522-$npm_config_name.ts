...
export class $npmConfigName1669053627522 implements MigrationInterface {
    name = '$npmConfigName1669053627522'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`card_learned\` DROP COLUMN \`learned_result\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`card_learned\` CHANGE \`learned_at\` \`learned_at\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`card_learned\` ADD \`learned_result\` tinyint NOT NULL`);
    }
