...
export class $npmConfigName1666100924064 implements MigrationInterface {
    name = '$npmConfigName1666100924064'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`example\` varchar(200) NULL`);
