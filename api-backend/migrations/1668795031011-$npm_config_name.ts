...
export class $npmConfigName1668795031011 implements MigrationInterface {
    name = '$npmConfigName1668795031011'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`folder_flashcard\` DROP COLUMN \`description\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`card_learned\` CHANGE \`learned_at\` \`learned_at\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`folder_flashcard\` ADD \`description\` varchar(255) NULL DEFAULT 'NULL'`);
    }
