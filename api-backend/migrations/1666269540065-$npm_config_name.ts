...
export class $npmConfigName1666269540065 implements MigrationInterface {
    name = '$npmConfigName1666269540065'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`dueDate\` date NOT NULL DEFAULT CURRENT_TIMESTAMP`);
