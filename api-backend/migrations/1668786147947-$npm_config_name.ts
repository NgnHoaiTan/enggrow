...
export class $npmConfigName1668786147947 implements MigrationInterface {
    name = '$npmConfigName1668786147947'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` DROP FOREIGN KEY \`FK_b7e2f290970e83c75850088f761\``);
        await queryRunner.query(`DROP INDEX \`IDX_b7e2f290970e83c75850088f76\` ON \`user\``);
        await queryRunner.query(`DROP INDEX \`REL_b7e2f290970e83c75850088f76\` ON \`user\``);
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`staffProfileId\` \`staff_profileId\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD UNIQUE INDEX \`IDX_801282d422e1568ed4e512a687\` (\`staff_profileId\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_801282d422e1568ed4e512a687\` ON \`user\` (\`staff_profileId\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`word_assessment\` DROP FOREIGN KEY \`FK_751f29c87b2d68c6bf77ba07fdb\``);
        await queryRunner.query(`ALTER TABLE \`staff_experience\` DROP FOREIGN KEY \`FK_0b7d1ebb48f77c3dccdaacd69f4\``);
        await queryRunner.query(`DROP INDEX \`REL_801282d422e1568ed4e512a687\` ON \`user\``);
        await queryRunner.query(`ALTER TABLE \`user\` DROP INDEX \`IDX_801282d422e1568ed4e512a687\``);
        ...
        await queryRunner.query(`ALTER TABLE \`card_learned\` CHANGE \`learned_at\` \`learned_at\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`staff_profileId\` \`staffProfileId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_b7e2f290970e83c75850088f76\` ON \`user\` (\`staffProfileId\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_b7e2f290970e83c75850088f76\` ON \`user\` (\`staffProfileId\`)`);
