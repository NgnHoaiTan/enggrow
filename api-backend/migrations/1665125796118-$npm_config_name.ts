...
export class $npmConfigName1665125796118 implements MigrationInterface {
    name = '$npmConfigName1665125796118'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`staff_experience\` ADD CONSTRAINT \`FK_0b7d1ebb48f77c3dccdaacd69f4\` FOREIGN KEY (\`staffProfileId\`) REFERENCES \`staff_profile\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`folder_flashcard\` DROP COLUMN \`progress\``);
        await queryRunner.query(`ALTER TABLE \`folder_flashcard\` ADD \`progress\` decimal(3,1) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`folder_flashcard\` CHANGE \`description\` \`description\` varchar(255) NOT NULL`);
