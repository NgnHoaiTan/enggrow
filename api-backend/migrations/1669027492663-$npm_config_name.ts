...
export class $npmConfigName1669027492663 implements MigrationInterface {
    name = '$npmConfigName1669027492663'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`meaning\` text NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`meaning\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`meaning\` varchar(50) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`card_learned\` CHANGE \`learned_at\` \`learned_at\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
    }
