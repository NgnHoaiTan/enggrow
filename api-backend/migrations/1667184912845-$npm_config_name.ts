...
export class $npmConfigName1667184912845 implements MigrationInterface {
    name = '$npmConfigName1667184912845'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`episode\` ADD \`video\` varchar(255) NULL`);
