...
export class $npmConfigName1668937393959 implements MigrationInterface {
    name = '$npmConfigName1668937393959'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`staff_experience\` ADD \`position\` varchar(50) NOT NULL`);
