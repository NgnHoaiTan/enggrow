...
export class $npmConfigName1667134657664 implements MigrationInterface {
    name = '$npmConfigName1667134657664'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`pronunciation_course\` DROP COLUMN \`description\``);
        await queryRunner.query(`ALTER TABLE \`pronunciation_course\` ADD \`description\` text NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`pronunciation_course\` DROP COLUMN \`description\``);
        await queryRunner.query(`ALTER TABLE \`pronunciation_course\` ADD \`description\` tinytext NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`pronunciation_course\` ADD CONSTRAINT \`FK_fd5d61d122a5e318d7835f66e96\` FOREIGN KEY (\`creatorId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
