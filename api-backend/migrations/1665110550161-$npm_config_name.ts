...
export class $npmConfigName1665110550161 implements MigrationInterface {
    name = '$npmConfigName1665110550161'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`current_avatar\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`googleId\` varchar(255) NULL DEFAULT 'NULL'`);
