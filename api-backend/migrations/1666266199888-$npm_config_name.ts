...
export class $npmConfigName1666266199888 implements MigrationInterface {
    name = '$npmConfigName1666266199888'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`efactor\` decimal(3,2) NOT NULL DEFAULT '2.50'`);
