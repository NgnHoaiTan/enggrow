...
export class $npmConfigName1666098631246 implements MigrationInterface {
    name = '$npmConfigName1666098631246'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`image\``);
        await queryRunner.query(`ALTER TABLE \`flashcard\` DROP COLUMN \`audio\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`audio\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`flashcard\` ADD \`image\` varchar(255) NULL DEFAULT 'NULL'`);
    }
