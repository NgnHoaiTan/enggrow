...
export class $npmConfigName1669126523562 implements MigrationInterface {
    name = '$npmConfigName1669126523562'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`card_learned\` CHANGE \`learned_at\` \`created_at\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`card_learned\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`card_learned\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`card_learned\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`card_learned\` ADD \`created_at\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`card_learned\` CHANGE \`created_at\` \`learned_at\` date NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
    }
