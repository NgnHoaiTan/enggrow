...
export class $npmConfigName1667634672828 implements MigrationInterface {
    name = '$npmConfigName1667634672828'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`pronunciation_exercise\` (\`id\` int NOT NULL AUTO_INCREMENT, \`phrase\` tinytext NOT NULL, \`meaning\` tinytext NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`episodeId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`identification_exercise\` (\`id\` int NOT NULL AUTO_INCREMENT, \`true_word\` varchar(20) NOT NULL, \`false_word\` varchar(20) NOT NULL, \`audio_url\` tinytext NOT NULL, \`audio_id\` tinytext NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`episodeId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`episode\` ADD \`fundamentals\` text NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`episode\` ADD \`description\` tinytext NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`episode\` DROP COLUMN \`fundamentals\``);
        await queryRunner.query(`DROP TABLE \`identification_exercise\``);
        await queryRunner.query(`DROP TABLE \`pronunciation_exercise\``);
    }
