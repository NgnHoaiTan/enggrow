...
import { asyncAddExperience, asyncGetMyProfile } from '../../features/profile/profileApis';

interface typeProps {
    showModel: boolean,
    onClose: () => void
}
const ModelAddExperience = (props: typeProps) => {
    ...
    const handleAddExperience = async(e: FormSubmitEvent) => {
        e.preventDefault()
        try {
            let staff_profile = profile.staff_profile
            let data = {
                position: dataInput.position,
                description: dataInput.description,
                from_time: startDate.toISOString(),
                to_time: endDate.toISOString(),
                profileId: staff_profile.id
            }
            let dataSubmit = {
                data: data,
                accessToken: accessToken
            }
            await dispatch(asyncAddExperience(dataSubmit)).unwrap()
...
export default ModelAddExperience;