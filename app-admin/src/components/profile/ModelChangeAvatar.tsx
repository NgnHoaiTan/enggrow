...
import { asyncChangeAvatar, asyncGetMyAlbumAvatar, asyncGetMyProfile, asyncUploadNewAvatar } from '../../features/profile/profileApis';
    ...
    const handleUploadNewAvatar = async (e: FormSubmitEvent) => {
        ...
        try {
            ...
            if (error.message) {
                ...
                setErrorUpload('Lỗi không xác định, xử lại sau !')
            )
        }
    }
                    ...
                    <div className="absolute bottom-0 left-1/2 -translate-x-1 -translate-y-1/2">
                        {
                            ...
                            <div className='z-10 bg-[#3f3f3f86] w-full py-1'>
                                <p className='text-white font-semibold text-center'>xin chờ...</p>
                            </div>
                        }
                    </div>
                    <div className="upload-new mt-5">
                        <div className=''>
                            <p className="font-semibold my-2">Đăng tải ảnh mới</p>
                        ...
                        </p>
                        {
                            albumAvatars ?
                                ...
                                <div className='font-semibold text-gray-400 mt-3'>
                                    <p>
                                        Bạn vẫn chưa có ảnh đại diện nào
                                    </p>
                                </div>
                        }
