    ...
    const handleInputFile = (e: any) => {
        ...
        if (e.target.files[0]) {
            ...
            if (isRightFormat) {
                ...
                setErrorFile(`${e.target.files[0].type} không được hỗ trợ, chỉ hỗ trợ jpg or png`)
            }
        }
    }
                ...
                >
                    ...
                    <Modal.Body>
                        <form onSubmit={handleUpdateCourse}>
                            ...
                            <div className="flex ">
                                <div className="mb-3 w-full">
                                    <label htmlFor="description" className="form-label inline-block mb-2 text-gray-700">
                                        Mô tả khóa học
                                    </label>
